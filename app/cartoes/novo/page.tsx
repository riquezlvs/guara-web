...
import { cadastrarCartao } from "@/lib/api";

export default function NovoCartaoPage() {
  const router = useRouter();

  // Estados do formulário sincronizados com a pré-visualização ao vivo
  const [nickname, setNickname] = useState("Nubank Principal");
  const [limit, setLimit] = useState("10.000,00");
            ...
            >
              {submitStatus === "syncing" ? (
                ...
                <>
                  ...
                  <span>Cartão Adicionado com Sucesso</span>
                </>
              ) : (
                <>
